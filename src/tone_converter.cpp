...
ToneConverter::ToneConverter()
{
	...
	outFormats_ = {
		...
		},
		{
			...
			"@%{NO}"
			"  %{AL:3} %{FB:3}\n"
			"  %{AR1:3} %{DR1:3} %{SR1:3} %{RR1:3} %{SL1:3} %{TL1:3} %{KS1:3} %{ML1:3} %{DT1:3}   0 %{AM1:3}\n"
			"  %{AR2:3} %{DR2:3} %{SR2:3} %{RR2:3} %{SL2:3} %{TL2:3} %{KS2:3} %{ML2:3} %{DT2:3}   0 %{AM2:3}\n"
			"  %{AR3:3} %{DR3:3} %{SR3:3} %{RR3:3} %{SL3:3} %{TL3:3} %{KS3:3} %{ML3:3} %{DT3:3}   0 %{AM3:3}\n"
			"  %{AR4:3} %{DR4:3} %{SR4:3} %{RR4:3} %{SL4:3} %{TL4:3} %{KS4:3} %{ML4:3} %{DT4:3}   0 %{AM4:3}"
		},
		{
			"MUCOM88",
			"@%{NO}:{\n"
